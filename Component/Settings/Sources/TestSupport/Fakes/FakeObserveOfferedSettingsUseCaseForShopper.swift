...
///
/// Kept apart from `SpyObserveOfferedSettingsUseCase` rather than merged with it. The
...
@MainActor
public struct FakeObserveOfferedSettingsUseCaseForShopper: ObserveOfferedSettingsUseCase {

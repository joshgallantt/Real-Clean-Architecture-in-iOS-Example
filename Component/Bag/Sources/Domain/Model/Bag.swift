...
public struct Bag: Equatable, Sendable {
    ...
    public func holds(productId: Int) -> Bool {
        items.contains { $0.productId == productId }
    }

    public func quantity(of productId: Int) -> Int {
    ...
    public func removing(productId: Int) -> Bag {
    ...
    public func changingQuantity(of productId: Int, to quantity: Int) -> Bag {

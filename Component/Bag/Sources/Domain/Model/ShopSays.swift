...
///
/// Evans, *Domain-Driven Design* (2003), Ch. 14 — Bounded Context: what the Bag asks of the Catalog, in the
/// Bag's own terms. Evans, Ch. 14 — Shared Kernel: `ProductID` and `Availability` are imported unchanged
